...
import cls from './WeekDayInfo.module.scss';
...
export const WeekDayInfo = observer(({ className, dayData }: WeekDayDescCardProps) => {
        ...
        <div className={classNames(cls.WeekDayDescCard, {}, [className])}>
            <Card padding={Padding.NONE}>
                <div className={cls.top}>
                    <div className={cls.day}>{ formatDay(dayData?.dt_txt) }</div>
                    <div className={cls.time}>{ formatDayOfWeek(dayData?.dt_txt) }</div>
                ...
                <div className={cls.bottom}>
                    <div className={cls.container}>
                        <div className={cls.info1}>
                            <p>
                                <span>Temp: </span>
                                { tempt(dayData?.main?.temp, degree) }
                                °
                                { degree }
                            </p>
                            <p>
                                <span>Real Feel: </span>
                                { tempt(dayData?.main?.feels_like, degree) }
                                °
                                { degree }
                            </p>
                            <p>
